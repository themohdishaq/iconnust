        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              />
              <button className="bg-[#FCAF17] text-white] text-white px-5 py-2 font-black text-[12px] uppercase cursor-pointer tracking-widest hover:bg-[#00558F] border  border-[#00558F] transition-colors">Subscribe</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 sm:mb-14 lg:mb-20 gap-6 lg:gap-10">
            ...
            <div className="flex gap-3">
              <Link href="https://www.linkedin.com/company/icon-nust" className="bg-white text-slate-900 px-6 py-3 font-black text-[12px] uppercase tracking-widest">LinkedIn Feed</Link>
              <button className="bg-[#FCAF17] text-white] text-white px-6 py-3 font-black text-[12px] uppercase tracking-widest hover:bg-[#00558F] border border-[#00558F] transition-colors">Licensed Tech</button>
            </div>
          </div>
